...
public class DBC {
	...
	final String DB_URL = "jdbc:mysql://localhost:3306/ims_db?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
